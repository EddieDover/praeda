...
namespace Praeda {
    ...
    public class PraedaGenerator : IDisposable {
        ...
        private static class NativeMethods {
            ...
            [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr praeda_generator_set_quality_data(IntPtr handle, string quality_name, int weight);

            [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr praeda_generator_set_item_type(IntPtr handle, string type_name, int weight);

            [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr praeda_generator_set_item_subtype(IntPtr handle, string type_name, string subtype_name, int weight);

            [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr praeda_generator_set_attribute(IntPtr handle, string type_name, string subtype_name,
                                                                       string attr_name, double initial_value, double min_value,
                                                                       double max_value, int required);

            [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl)]
            public static extern IntPtr praeda_generator_set_item_names(IntPtr handle, string type_name, string subtype_name,
                                                                        string names_json);
        ...
        public bool SetQualityData(string qualityName, int weight) {
            ThrowIfDisposed();
            IntPtr resultPtr = NativeMethods.praeda_generator_set_quality_data(handle, qualityName, weight);
            string result = MarshalString(resultPtr);
            CheckResult(result);
            return true;
        }
        ...
        public bool SetItemType(string typeName, int weight) {
            ThrowIfDisposed();
            IntPtr resultPtr = NativeMethods.praeda_generator_set_item_type(handle, typeName, weight);
            string result = MarshalString(resultPtr);
            CheckResult(result);
            return true;
        }
        ...
        public bool SetItemSubtype(string typeName, string subtypeName, int weight) {
            ThrowIfDisposed();
            IntPtr resultPtr = NativeMethods.praeda_generator_set_item_subtype(handle, typeName, subtypeName, weight);
            string result = MarshalString(resultPtr);
            CheckResult(result);
            return true;
        }
        ...
        public bool SetAttribute(string typeName, string subtypeName, string attrName,
            ...
            ThrowIfDisposed();
            IntPtr resultPtr = NativeMethods.praeda_generator_set_attribute(
                handle, typeName, subtypeName, attrName, initialValue, minValue, maxValue, required ? 1 : 0);
            string result = MarshalString(resultPtr);
            CheckResult(result);
            return true;
        }
        ...
        public bool SetItemNames(string typeName, string subtypeName, string[] names) {
            ThrowIfDisposed();
            // Convert names array to JSON array string
            string namesJson = JsonSerializer.Serialize(names);
            IntPtr resultPtr = NativeMethods.praeda_generator_set_item_names(handle, typeName, subtypeName, namesJson);
            string result = MarshalString(resultPtr);
            CheckResult(result);
            return true;
        }
